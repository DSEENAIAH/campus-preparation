...
Write-Host "`n📱 Creating Cognito App Client..." -ForegroundColor Cyan
...
Write-Host "`n🗄️ Creating DynamoDB Tables..." -ForegroundColor Cyan
...
Write-Host "`n🔑 Creating IAM Policy..." -ForegroundColor Cyan
...
if ($policyArn) {
    ...
    Write-Host "⚠️ Policy might already exist or there was an issue" -ForegroundColor Yellow
}

# 5. Create IAM User for the application
Write-Host "`n👤 Creating IAM User..." -ForegroundColor Cyan
...
Write-Host "`n👨‍💼 Creating admin user in Cognito..." -ForegroundColor Cyan
...
Write-Host "`n🪣 Creating S3 bucket for static hosting..." -ForegroundColor Cyan
...
Write-Host "`n📄 Generating environment configuration..." -ForegroundColor Cyan
...
# 9. Summary
Write-Host "`n🎉 AWS Services Deployment Complete!" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
